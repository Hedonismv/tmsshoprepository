...
class Product(models.Model):
    ...
    size = models.ManyToManyField(Size, help_text='Sizes of the products that are offered',
                                  related_name='sizes_for_product')
...
class Customer(models.Model):
    ...
    email = models.CharField(max_length=20, verbose_name='Электронная почта', null=True, blank=True)
